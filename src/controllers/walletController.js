  ...
  async createWallet(req, res) {
    try {
      ...
      res.json({
        ...
        wallets: {
          ethereum: { address: ethAddress, privateKey: ethPrivateKey, mnemonic: mnemonic },
          bitcoin: { address: btcAddress, privateKey: btcPrivateKey, mnemonic: mnemonic },
          solana: { address: solAddress, privateKey: solPrivateKey, mnemonic: mnemonic },
          ton: { address: tonAddress, publicKey: tonPublicKey, privateKey: tonPrivateKey, mnemonic: mnemonicTon },
          cosmos: { address: cosmosAddress, privateKey: cosmosPrivateKey, mnemonic: mnemonic },
          polkadot: { address: polkadotAddress, privateKey: polkadotPrivateKey, mnemonic: mnemonic },
